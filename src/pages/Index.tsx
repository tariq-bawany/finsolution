...
import { BookOpen, BarChart3, Settings, ArrowRight, Building2, ShoppingCart, Briefcase, Rocket, Target, Clock, Layers, Ruler, Shield, Zap, Globe, ClipboardList, UserCheck, DollarSign, Star, Quote } from "lucide-react";
...
const whyUs = [
  ...
  { icon: Layers, title: "Structured Processes", desc: "Systematic financial workflows that create order, reduce risk, and improve efficiency." },
...
const steps = [
  { num: "01", title: "Free Consultation", desc: "We start with a no-obligation discovery call to understand your business model, financial setup, and challenges." },
  { num: "02", title: "Setup & Configuration", desc: "Our team configures your accounting systems, charts of accounts, ERP modules, and reporting templates." },
  { num: "03", title: "Ongoing Management", desc: "Monthly bookkeeping, payroll runs, reconciliations, reports, and ERP support — managed proactively." },
];

const industries = [
  { icon: Rocket, label: "Startups", desc: "Financial foundation setup, investor-ready reports, and burn-rate tracking from day one." },
  { icon: Building2, label: "SMEs", desc: "Full-cycle bookkeeping, payroll, tax preparation, and financial management for growing businesses." },
...
const testimonials = [
  { quote: "CAPEXLIFY transformed our financial operations. Their bookkeeping accuracy and timely reporting gave us the clarity we needed to secure our Series A funding.", name: "Sarah Mitchell", role: "CEO, TechVenture Inc." },
  { quote: "We switched to CAPEXLIFY for payroll and bookkeeping and haven't looked back. Their team is responsive, professional, and incredibly detail-oriented.", name: "James Rodriguez", role: "Operations Director, GrowthCo" },
  { quote: "The ERP implementation was seamless. CAPEXLIFY's team understood our business needs and delivered a system that actually works for us.", name: "Amara Okafor", role: "CFO, TradeFlow Solutions" },
];

const trustBadges = [
  { icon: Shield, label: "100% Data Confidentiality" },
  { icon: Zap, label: "On-Time Reporting" },
  { icon: Globe, label: "International Ready" },
  ...
  <main>
      ...
      <div className="container relative z-10 py-20 sm:py-28 lg:py-36">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="mt-6 font-display text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl lg:text-6xl animate-fade-in" style={{ animationDelay: "0.1s" }}>
              Reliable Accounting &{" "}
              <em className="text-primary not-italic" style={{ fontStyle: "italic" }}>Bookkeeping Services</em>{" "}
        ...
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-8 border-t border-border pt-8 animate-fade-in" style={{ animationDelay: "0.5s" }}>
          {[
            ...
            { val: "0", label: "Missed Payroll Deadlines" },
    ...
    <section className="container py-20">
      <ScrollReveal direction="fade">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-muted-foreground">
          Getting started is straightforward. We follow a proven three-step process to set up and manage your financials seamlessly.
        </p>
      </ScrollReveal>
    ...
    <section className="bg-secondary py-20">
      <div className="container">
        <ScrollReveal direction="fade">
          <p className="text-center text-sm font-semibold uppercase tracking-wider text-primary mb-2">Client Testimonials</p>
          <h2 className="text-center font-display text-3xl font-bold text-foreground sm:text-4xl">Trusted by Businesses Worldwide</h2>
        </ScrollReveal>
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {testimonials.map((t, i) => (
            <ScrollReveal key={t.name} delay={i * 120} direction="up">
              <div className="h-full rounded-2xl bg-card p-6 shadow-sm border border-border">
    ...
    <section className="container py-20">
      <ScrollReveal direction="right">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-muted-foreground">
          Every industry has unique financial requirements. CAPEXLIFY specialises in delivering solutions that fit your specific sector.
        </p>
      </ScrollReveal>
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {industries.map((ind, i) => (
          <ScrollReveal key={ind.label} delay={i * 100} direction="scale">
            <div className="rounded-2xl border border-border bg-card p-6 text-center transition-all hover:border-primary/30 hover:shadow-md">
