...
import { BookOpen, BarChart3, Settings, CheckCircle, ArrowRight, Building2, ShoppingCart, Briefcase, Rocket, Target, Clock, Layers, Ruler, Shield, Zap, Globe, ClipboardList, UserCheck } from "lucide-react";
...
const services = [
  ...
  { icon: Settings, title: "ERP Implementation", description: "End-to-end ERP system setup, configuration, data migration, and process automation tailored to your business operations — from basic to intermediate scale." },
];
...
const steps = [
  ...
  { num: "03", title: "Ongoing Management", desc: "Monthly bookkeeping, reconciliations, reports, and ERP support — managed proactively so nothing falls through the cracks." },
];

const industries = [
  { icon: Rocket, label: "Startups", desc: "Financial foundation setup, investor-ready reports, and burn-rate tracking from day one." },
  { icon: Building2, label: "SMEs", desc: "Full-cycle bookkeeping, tax preparation, and financial management for growing mid-size businesses." },
  ...
  <main>
    ...
    <section className="relative overflow-hidden" style={{ background: "var(--hero-gradient)" }}>
      <div className="container relative z-10 py-20 sm:py-28 lg:py-36">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-lg text-lg text-muted-foreground animate-fade-in" style={{ animationDelay: "0.2s" }}>
              We manage your financial records, reporting, and ERP systems so you can focus entirely on scaling your business with confidence.
            </p>
          ...
          <div className="hidden lg:block animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <div className="relative">
              <div className="absolute -top-3 -left-3 rounded-lg bg-accent/20 px-3 py-1.5 text-xs font-medium text-accent">
              ...
              <div className="rounded-xl border border-border bg-card p-6 shadow-2xl">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="rounded-full bg-primary/20 px-2.5 py-0.5 text-xs font-medium text-primary">Q4 2024</span>
                </div>
        ...
        {/* Stats bar */}
        <div className="mt-16 grid grid-cols-3 gap-8 border-t border-border pt-8 animate-fade-in" style={{ animationDelay: "0.5s" }}>
          <div>
    ...
    <section className="container py-20">
      <ScrollReveal direction="fade">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-muted-foreground">
          From day-to-day bookkeeping to full-scale ERP implementation — CAPEXLIFY delivers structured financial solutions that drive clarity and control.
        </p>
      </ScrollReveal>
        ...
        {services.map((s, i) => (
          <ScrollReveal key={s.title} delay={i * 120} direction="scale">
            <div className="group h-full rounded-xl border border-border bg-card p-6 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
              ...
              <Link to="/services" className="mt-4 inline-flex items-center text-sm font-medium text-primary hover:text-primary/80 transition-colors">
