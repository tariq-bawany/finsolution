      ...
      <section className="py-16 border-b border-border">
        <div className="container">
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground">
            We are developing a purpose-built ERP solution specifically tailored for rental-based businesses. Manage your inventory, automate billing cycles, track asset utilisation, and maintain crystal-clear financial reporting — all in one integrated platform.
          </p>
        </div>
      </section>
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    We'll notify you the moment our Rental ERP goes live. Expect exclusive early access benefits.
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <p className="text-sm text-muted-foreground mb-6">
                    Be the first to know when our Rental ERP launches. Join the early access list and receive exclusive founding member pricing.
                  </p>
